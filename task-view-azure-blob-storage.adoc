...
summary: 'Dopo aver installato un agente Console in Azure, la NetApp Console può individuare automaticamente informazioni sugli account di archiviazione di Azure che risiedono nelle sottoscrizioni di Azure in cui è installato l"agente Console.' 
---
