...
.Passi
. https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html["Installa un agente Console"^]nell'account Azure in cui desideri visualizzare gli account di archiviazione BLOB di Azure.
