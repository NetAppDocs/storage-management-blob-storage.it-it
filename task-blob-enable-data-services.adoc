...
summary: Dopo aver individuato gli account di archiviazione BLOB di Azure nella NetApp Console, è possibile utilizzare i servizi dati NetApp per il backup, la suddivisione in livelli e la sincronizzazione dei dati. 
---
...
[role="lead"]
Dopo aver individuato gli account di archiviazione BLOB di Azure nella NetApp Console, è possibile utilizzare i servizi dati NetApp per il backup, la suddivisione in livelli e la sincronizzazione dei dati.
