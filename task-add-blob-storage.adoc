...
summary: Una volta che il sistema Azure Blob Storage è disponibile nella pagina dei sistemi NetApp Console , è possibile aggiungere altri account di archiviazione direttamente dalla console. 
---
= Aggiungere account di archiviazione BLOB di Azure nella NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Una volta che il sistema Azure Blob Storage è disponibile nella pagina dei sistemi NetApp Console , è possibile aggiungere altri account di archiviazione direttamente dalla console.
